...
var2 = every_second_line[1]#speed
var3 = int(every_second_line[2])#camere
var4 = int(every_second_line[3])#camere
...
# и таeval(к далее, в зависимости от количества вторых строк, которые вы хотите сохранить

#lower_yellow = np.array([20, 100, 100])
#upper_yellow = np.array([30, 255, 255])
#lower_green = np.array([54,83,50])
#upper_green = np.array([94,117,100])
